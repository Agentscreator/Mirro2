                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-4">
                      ...
                      <div className="h-40 overflow-y-auto bg-black/20 rounded-lg p-3 text-xs text-slate-300 mb-4">
                        ...
                        <p className="mb-2">
                          ...
                          Mirro a non-exclusive license to use, display, and distribute your content.
                        </p>
                        <p className="mb-2">
                          <strong>Conduct:</strong> You agree not to use Mirro for any illegal or unauthorized purpose.
                          You will not violate any laws or regulations.
                        </p>
                        <p>

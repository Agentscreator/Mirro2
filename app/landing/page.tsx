      ...
      <section className="relative z-10 px-6 py-16 md:py-24 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            Welcome to Mirro—a living space crafted entirely for you. In a world overflowing with noise, Mirro offers
            quiet. A gentle, private space where you can reflect, express, and evolve. Mirro is your mirror, your
            archive, and your companion for the journey inward and forward.
          </p>
      ...
      <footer className="relative z-10 px-6 py-8 border-t border-white/10">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-light">Mirro</span>
          </div>
